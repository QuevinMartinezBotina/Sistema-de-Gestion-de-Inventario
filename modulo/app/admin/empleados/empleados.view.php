                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class=" nav-link p-3  " href="../usuarios/usuarios.php"><i class="fas fa-users icono"></i> Usuarios</a>
                                <a class=" nav-link p-3" href="../proveedores/proveedores.php"><i class="fas fa-truck icono"></i> Proveedores</a>
                                <a class=" nav-link p-3 " href="../cargos/cargos.php"><i class="fa fa-address-card icono" aria-hidden="true"></i> Cargos</a>
                                ...
                                <a class=" nav-link p-3 active" href="#"><i class="fa fa-male icono"></i> Empleados</a>
                ...
                <div class="col-12">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active texto	" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="row">
                                <div class="col-12">
                                    <h1 class="text-center texto-usuarios p-2">Empleados</h1>
