...
<body>
  ...
  <div class="container-fluid px-md-3 animacion-lateral">
    ...
    if ($tam == 0) {
      echo "<br><p><strong>No se encontro registro de empleados!!</strong></p>";
    } else {
    ...
    ?>
      ...
      <table class="table table-striped py-3 table-hover table-borderless mb-4 pb-5" id="tabla">
        ...
        <thead class="thead-dark ">
          ...
          <th class="py-3 px-2">ID Empleado</th>
          <th class="py-3 px-2">Primer Apellido</th>
          <th class="py-3 px-2">Segundo Apellido</th>
          <th class="py-3 px-2">Primer Nombre</th>
          <th class="py-3 px-2">Segundo Nombre</th>
          <th class="py-3">Email</th>
          <th class="py-3 px-2">Celular</th>
          <th class="py-3 px-2">Dirección</th>
          <th class="py-3 px-2">ID Sucursal</th>
          <th class="py-3 px-2">ID Cargo </th>
          <th class="py-3 px-2">Ciudad</th>
          <th class="py-3 px-2">Departamento</th>
          <th class="py-3 px-2">Fecha Contratación</th>
        ...
        <tbody>
          ...
          foreach ($usuarios as $usuario) {
            echo "<tr >" .
              ...
              "<td class=' pt-4'>" . $usuario["priapell"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["segapell"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["prinom"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["segnom"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["email"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["celular"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["direccion"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["idsucursal"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["idcargo"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["ciudad"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["departamento"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["fecha_contratarcion"] . "</td>" .
